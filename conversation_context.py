...
{{
  ...
  "transition_message": "If creating new context, a message describing what key information should be carried forward"
    ...
    # Skip OpenAI context switching for now - using Claude only
    response = ""
...
JSON:"""
        ...
        # Skip OpenAI memory extraction for now - using Claude only
        response = "[]"
...
JSON:"""
        ...
        # Skip OpenAI context summarization for now - using Claude only
        response = ""
...
JSON:"""
    ...
    # Skip OpenAI memory consolidation for now - using Claude only
    response = "[]"
