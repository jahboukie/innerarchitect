...
class PracticeReminder:
    ...
    def to_dict(self):
        ...
        return {
            ...
            'reminder_type_display': REMINDER_TYPES.get(str(self.reminder_type) if self.reminder_type else 'custom', 'Custom Reminder'),
            'frequency': self.frequency,
            'frequency_display': REMINDER_FREQUENCIES.get(str(self.frequency) if self.frequency else 'custom', 'Custom'),
