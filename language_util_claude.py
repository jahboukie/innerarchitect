...
and language detection using Anthropic Claude.
"""
...
# External Anthropic Claude API for translations and language detection
    ...
    while attempts < retry_count:
        try:
            ...
            if retryable and attempts < retry_count:
                ...
                error_message = f"Error calling Claude API ({error_type}): {str(e)}"
